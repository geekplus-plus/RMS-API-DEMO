...
public class HttpHeader {
    ...
    public static HttpHeader[] getJsonHeaderWithOtherHeader(HttpHeader otherHeader) {
        return new HttpHeader[]{new HttpHeader(CONTENT_TYPE, ContentType.APPLICATION_JSON.getContentType()), otherHeader};
    }
    ...
    public static HttpHeader createAuthorizationHeader(String value) {
